                         ...
                         <div class="row">
                              <div class="col-lg-6 col-md-6 col-6">
                                   <ul class="list-group">
                                        ...
                                        <li class="list-group-item">Name: {{ orders.customer_name }}</li>
                                        <li class="list-group-item">Phone: {{ orders.customer_phone }}</li>
                                        <li class="list-group-item">Address: {{ orders.customer_address }}</li>
