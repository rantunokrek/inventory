          ...
          <div class="row ">
               <div class="card col-lg-5">
                    <div class="card-header">
                         ...
                         Expense Insert
                         <a class="btn btn-sm btn-info" data-toggle="modal" data-target="#exampleModal" id="add_new"> Add
                              Customer</a>
                    </div>
                              ...
                              <tbody>
                                   <tr v-for="cart in carts" :key="cart.id">
                                        ...
                                        <td><input type="text" readonly="" style="width: 20px;" :value="cart.pro_quantity">
                                             ...
                                             <button @click.prevent="decrement(cart.id)" v-if="cart.pro_quantity >= 2"
                                                  class="btn btn-sm btn-danger">-</button>
                                             <button v-else="" disabled="" class="btn btn-sm btn-danger">-</button>

                                        </td>
                                        <td>{{ cart.product_price }}</td>
                                        <td>{{ cart.sub_total }}</td>
                                        <td> <a @click="removeItem(cart.id)" class="btn btn-sm btn-danger"> x</a>
                                        </td>
                         ...
                         <form @submit.prevent="orderdone">
                              ...
                              <div class="form-group">
                                   ...
                                   <select class="form-control" v-model="customer_id" id="exampleFormControlSelect1">
                                        <option :value="customer.id" v-for="customer in customers">{{ customer.customer_name
                                        }}
                                        </option>
                                   </select>
                              </div>
                                             ...
                                             <div class="col">
                                                  <div class="form-floating mb-3">
                                                       <input name="name" class="form-control" id="inputEmail" type="text"
                                                            placeholder="full name" v-model="form.customer_name" />
                                             ...
                                             <div class="col">
                                                  <div class="form-floating mb-3">
                                                       <input name="address" class="form-control" id="address" type="text"
                                                            placeholder="customer_address" v-model="form.customer_address" />
                    ...
                    <div class="card-body">
                         ...
                         <div class="tab-content" id="pills-tabContent">
                              ...
                              <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                   ...
                                   <div class="row">
                                        <div class="col-lg-3 col-md-4 col-sm-6 col-6" v-for="product in filtersearch"
                                             :key="product.id">
                                                  ...
                                                  <div class="card" style="width: 9rem; height: 180px;">
                                                       ...
                                                       <div class="card-body">
                                                            ...
                                                            <span class="badge badge-success"
                                                                 v-if="product.product_quality >= 1"> Availble ({{
                                                                      product.product_quality }}) </span>
                                             ...
                                             <button class="btn btn-sm" @click.prevent="AddToCart(getproduct.id)">
                                                  <div class="card" style="width: 9rem; height: 180px;">
                                                       ...
                                                       <div class="card-body">
                                                            ...
                                                            <span class="badge badge-success"
                                                                 v-if="getproduct.product_quality >= 1"> Availble ({{
                                                                      getproduct.product_quality }}) </span>
                                                            <span class="badge badge-danger" v-else="">Stock Out</span>
                                                       </div>
                                                  </div>
                                             </button>
               ...
               axios.get('/api/remove/cart/' + id)
                    .then(() => {
                         ...
                         Toast.fire({
                              icon: "error",
                              type: 'error',
                              title: "Art Removed successfully"
                         });
                    })
          },
          increment(id) {
